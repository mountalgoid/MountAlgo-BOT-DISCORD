...
SERVER_STRUCTURE = [
    ...
    ("🌐|MNA NETWORK|", ["@Admin"], [
        ("id", "Informasi identitas dan status akun (Dalam Pengembangan).", ["@Admin"]),
        ("wallet", "Informasi dompet digital dan transaksi (Dalam Pengembangan).", ["@Admin"]),
        ("pasar-p2p", "Pasar Peer-to-Peer (Dalam Pengembangan).", ["@Admin"]),
    ]),
